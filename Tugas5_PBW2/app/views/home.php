...
<head>
  ...
  <title>Aplikasi Toko 0048</title>
...
<div class="wrapper">
    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title font-weight-bold">HOME</h3>
        </div>
        <div class="card-body">
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; <span id="year"></span> <a href="#">23.240.0048</a>.</strong> All rights reserved.
  </footer>
